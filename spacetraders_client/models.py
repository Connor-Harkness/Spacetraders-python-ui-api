...
#   timestamp: 2025-07-14T10:44:19+00:00
...
class PublicAgent(BaseModel):
    ...
    shipCount: int = Field(..., description='How many ships are owned by the agent.')
...
class JumpGate(BaseModel):
    ...
    connections: Sequence[str] = Field(
...
class ShipMount(BaseModel):
    symbol: Symbol4 = Field(..., description='Symbol of this mount.')
    name: str = Field(..., description='Name of this mount.')
    description: str = Field(..., description='Description of this mount.')
    ...
    deposits: Sequence[Deposit] | None = Field(
        None,
...
class ShipConditionEvent(BaseModel):
    symbol: Symbol5 = Field(..., description='The symbol of the event that occurred.')
    component: Component
...
class SystemWaypoint(BaseModel):
    ...
    orbitals: Sequence[WaypointOrbital] = Field(
...
class ShipCargo(BaseModel):
    ...
    inventory: Sequence[ShipCargoItem] = Field(
...
class ContractTerms(BaseModel):
    ...
    deliver: Sequence[ContractDeliverGood] | None = Field(
        None,
...
class Survey(BaseModel):
    ...
    deposits: Sequence[SurveyDeposit] = Field(
        ...,
...
class ScannedWaypoint(BaseModel):
    ...
    traits: Sequence[WaypointTrait] = Field(
...
class Faction(BaseModel):
    ...
    traits: Sequence[FactionTrait] = Field(
...
class System(BaseModel):
    ...
    waypoints: Sequence[SystemWaypoint] = Field(
        ..., description='Waypoints in this system.'
    )
    factions: Sequence[SystemFaction] = Field(
...
class Waypoint(BaseModel):
    ...
    modifiers: Sequence[WaypointModifier] | None = Field(
...
class Construction(BaseModel):
    ...
    materials: Sequence[ConstructionMaterial] = Field(
...
class ShipyardShip(BaseModel):
    ...
    description: str = Field(..., description='Description of the ship.')
    activity: ActivityLevel | None = None
    supply: SupplyLevel
    purchasePrice: int = Field(..., description='The purchase price of the ship.')
    frame: ShipFrame
    reactor: ShipReactor
    engine: ShipEngine
    modules: Sequence[ShipModule] = Field(
        ..., description='Modules installed in this ship.'
    )
    mounts: Sequence[ShipMount] = Field(
...
class Contract(BaseModel):
    ...
    type: Type2 = Field(..., description='Type of contract.')
    terms: ContractTerms
    accepted: bool = Field(
    ...
    deadlineToAccept: datetime | None = Field(
        None,
...
class Ship(BaseModel):
    ...
    registration: Optional[ShipRegistration] = None
    nav: Optional[ShipNav] = None
    crew: Optional[ShipCrew] = None
    frame: Optional[ShipFrame] = None
    reactor: Optional[ShipReactor] = None
    engine: Optional[ShipEngine] = None
    modules: Optional[Sequence[ShipModule]] = Field(
        None, description='Modules installed in this ship.'
    )
    mounts: Optional[Sequence[ShipMount]] = Field(
        None, description='Mounts installed in this ship.'
    )
    cargo: Optional[ShipCargo] = None
    fuel: Optional[ShipFuel] = None
